...
module.exports = function(app) {
  ...
  var whitelist = [
	...
	function whitelistCheck(req, res, next) {
		...
		request(tcAPI + 'v2/user/tcid/' + req.user.user_id, function (error, response, body) {
			console.log('going out to qa api', tcAPI, error, response)
			//TODO: error handleing
		  if (!error && response.statusCode == 200) {
		    body = JSON.parse(body);
				if (whitelist.indexOf(body.handle) < 0) {
