...
module.exports = function(app) {
  ...
  function whitelist(req, res, next) {
  	console.debug('checking which whitelist to use', authDisabled)
  	if (authDisabled && (authDisabled == 'true')) {
  ...
  function mockWhitelistCheck(req, res, next) {
  	console.debug('in mockWhitelistCheck')
    var tcUser = {
	...
	function whitelistCheck(req, res, next) {
		console.debug('in whitelistCheck')
		...
		if (!req.user || !req.user.sub) {
			...
			// var options = {
			// 	url: tcAPI + '/v2/user/profile/' + req.user.sub,
			//   headers: {
